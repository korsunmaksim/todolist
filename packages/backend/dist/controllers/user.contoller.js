...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.getUser = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.getUser(req.user)];
                    case 1:
                        user = _a.sent();
    ...
    UserController.prototype.register = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.userService.create(req.body)];
            });
        });
    };
    UserController.prototype.login = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.userService.login(req.body)];
            });
        });
    };
    UserController.prototype.changePassword = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.userService.changePassword(req.body, req.user)];
            });
        });
    };
