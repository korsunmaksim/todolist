...
var TodoController = /** @class */ (function () {
    ...
    TodoController.prototype.getUncompletedTodos = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.todoService.getUncompleted(req.user)];
                    case 1:
                        todos = _a.sent();
    ...
    TodoController.prototype.getCompletedTodos = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.todoService.getCompleted(req.user)];
                    case 1:
                        todos = _a.sent();
                        return [2 /*return*/, todos];
                }
    ...
    TodoController.prototype.getTodo = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.todoService.getById(req.params.id, req.user)];
                    case 1:
                        todo = _a.sent();
    ...
    TodoController.prototype.createTodo = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.todoService.create(req.body, req.user)];
                    case 1:
                        newTodo = _a.sent();
    ...
    TodoController.prototype.updateTodo = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.todoService.update(req.params.id, req.body, req.user)];
                    case 1:
                        updatedTodo = _a.sent();
    ...
    TodoController.prototype.deleteTodo = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.todoService.delete(req.params.id, req.user)];
                    case 1:
                        deletedTodo = _a.sent();
