...
exports.isExist = function (model) {
    return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!(model.modelName === User_models_1.default.modelName)) return [3 /*break*/, 2];
                    return [4 /*yield*/, model.findOne({ email: req.body.email })];
                case 1:
                    object = _b.sent();
                    return [2 /*return*/, object
                            ...
                            : next()];
                case 2:
                    if (!(((_a = req.params) === null || _a === void 0 ? void 0 : _a.id.length) === 24)) return [3 /*break*/, 4];
